...
namespace SSBehaviorTree
{
    void SSBehaviorTreeSystemComponent::Reflect(AZ::ReflectContext *context)
    {
        ...
        {
            serialize->Class<SSBehaviorTreeSystemComponent, AZ::Component>()
                ->Version(0);

            if (AZ::EditContext *ec = serialize->GetEditContext())
            {
                ec->Class<SSBehaviorTreeSystemComponent>("SSBehaviorTree", "[Description of functionality provided by this System Component]")
