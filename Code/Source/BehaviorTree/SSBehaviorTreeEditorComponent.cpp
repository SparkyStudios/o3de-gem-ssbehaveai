...
namespace SparkyStudios::AI::Behave::BehaviorTree
{
    ...
    void SSBehaviorTreeEditorComponent::SetBehaviorTree(const AZ::Data::Asset<Assets::SSBehaviorTreeAsset>& tree)
    {
        ...
        m_customName = "Behave AI - BehaviorTree";
        ...
        if (auto* sc = azrtti_cast<AZ::SerializeContext*>(reflection))
        {
            ...
            if (AZ::EditContext* ec = sc->GetEditContext())
            {
                ec->Class<SSBehaviorTreeEditorComponent>(
                    ...
                    ->DataElement(
                        AZ::Edit::UIHandlers::Default, &SSBehaviorTreeEditorComponent::m_behaviorTreeComponent, "BehaviorTree properties",
                        "The behavior tree")
                ...
                ec->Class<SSBehaviorTreeComponent>(
                      "BehaviorTree Component", "Add custom behavior trees to the entity, using the powerfull BehaviorTree.CPP library.")
                ...
                ec->Class<SSBehaviorTreeBlackboard>("BehaviorTree Blackboard", "The blackboard of a behavior tree.")
                ...
                ec->Class<SSBehaviorTreeBlackboardProperty>("BehaviorTree Blackboard Property", "Base class for blackboard properties")
                ...
                ec->Class<SSBehaviorTreeBlackboardPropertyBoolean>("BehaviorTree Property (bool)", "A blackboard boolean property")
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "SSBehaviorTreeBlackboardProperty's class attributes.")
                    ->Attribute(AZ::Edit::Attributes::Visibility, &SSBehaviorTreeBlackboardProperty::m_visibility)
                ...
                ec->Class<SSBehaviorTreeBlackboardPropertyNumber>(
                      "BehaviorTree Blackboard Property (number)", "A blackboard number property")
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "SSBehaviorTreeBlackboardProperty's class attributes.")
                    ->Attribute(AZ::Edit::Attributes::Visibility, &SSBehaviorTreeBlackboardProperty::m_visibility)
                ...
                ec->Class<SSBehaviorTreeBlackboardPropertyString>(
                      "BehaviorTree Blackboard Property (string)", "A blackboard string property")
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "SSBehaviorTreeBlackboardProperty's class attributes.")
                    ->Attribute(AZ::Edit::Attributes::Visibility, &SSBehaviorTreeBlackboardProperty::m_visibility)
                ...
                ec->Class<SSBehaviorTreeBlackboardPropertyVector2>(
                      "BehaviorTree Blackboard Property (Vector2)", "A blackboard Vector2 property")
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "SSBehaviorTreeBlackboardProperty's class attributes.")
                    ->Attribute(AZ::Edit::Attributes::Visibility, &SSBehaviorTreeBlackboardProperty::m_visibility)
