...
namespace SparkyStudios::AI::Behave::BehaviorTree::Nodes::Animation
{
    ...
    public:
        ...
        AnimGraphSetNamedParameterRotationEulerNode(const std::string& name, const Core::BehaviorTreeNodeConfiguration& config);

        static void Reflect(AZ::ReflectContext* r);
