                  ...
                  QTransform const & t) const
{
  ...
  if( _ports_layout == PortLayout::Horizontal)
  {
    ...
    double x = (portType == PortType::Out) ? _width + nodeStyle.ConnectionPointDiameter :
  ...
  else
  {
    ...
    double y = (portType == PortType::Out) ? _height + nodeStyle.ConnectionPointDiameter :
                                             - nodeStyle.ConnectionPointDiameter;
...
void
NodeGeometry::
setPortLayout(QtNodes::PortLayout layout)
{
